...
class TwilioScraper(BaseScraper):
    """Scraper for Twilio documentation"""

    def __init__(self):
        """Initialize Twilio scraper"""
        super().__init__(
            vendor="twilio",
            base_url="https://www.twilio.com",
            rate_limit_delay=1.0
        )
        self.base_docs_url = "https://www.twilio.com/docs"

    def get_start_urls(self) -> List[str]:
        """Get Twilio documentation starting URLs"""
        return [
            "https://www.twilio.com/docs/voice",
            "https://www.twilio.com/docs/voice/twiml",
            "https://www.twilio.com/docs/voice/media-streams",
            "https://www.twilio.com/docs/voice/ai-voice-insights",
            "https://www.twilio.com/docs/voice/api",
            "https://www.twilio.com/docs/voice/webhooks",
            "https://www.twilio.com/docs/voice/quickstart",
        ]

    def extract_links(self, html: str, current_url: str) -> List[str]:
        """Extract links from Twilio documentation"""
        ...
        for link in soup.find_all('a', href=True):
            ...
            if 'twilio.com/docs' in full_url:
    ...
    async def extract_content(self, html: str, url: str) -> Dict[str, Any]:
        """Extract content from Twilio documentation page"""
        soup = BeautifulSoup(html, 'html.parser')
        ...
        main_content = soup.find('main') or soup.find('article') or soup.find('div', class_=re.compile('content|main|article|docs-content'))
        if not main_content:
        ...
        # Extract TwiML elements
        twiml_elements = []
        twiml_pattern = re.compile(r'<(\w+)>', re.IGNORECASE)
        for match in twiml_pattern.finditer(content):
            twiml_elements.append(match.group(1).lower())
        ...
        metadata.update({
            ...
            "twiml_elements": list(set(twiml_elements)),
            "vendor": "twilio",
        })
